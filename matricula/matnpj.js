...
function Ofcoord() {
    ...
    camp.addEventListener('change', (event) => {
        ...
        if (camp.value != "parang") {
            ...
            ofcoord.innerHTML += 
            `<label for="ofcoord"><p><strong>Anexe um ofício da Coordenação do seu campus:</strong></p></label>
            <input type="file" id="ofcoord" multiple size="50" onchange="Anexa()" required>`;
...
function Aprv() {
    ...
    aprv.addEventListener('change', (event) => {
        ...
        if (aprv.value == "s") {
            ...
            tce.innerHTML = `<br></br>`
            tce.innerHTML += 
            `<label for="ofcoord"><p><strong>Anexe o Termo de Compromisso de estágio:</strong></p></label>
            <input type="file" id="tce" multiple size="50" onchange="Anexa()" required>`;

            ceoab.innerHTML = `<br></br>`
            ceoab.innerHTML +=
            `<label for="ofcoord"><p><strong>Anexe a sua Carteira de Estudante da OAB (ou o protocolo de entrada para obtenção do documento):</strong></p></label>
            <input type="file" id="tce" multiple size="50" onchange="Anexa()" required>`;
